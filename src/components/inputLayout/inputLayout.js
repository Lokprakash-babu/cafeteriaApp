...
const inputLayout=(props)=>{
    return (
        <div>
            <FormInputs label='name' place="Full name" informer="Enter your full name" type='text' change={props.change} name='Full Name:'/>
            <FormInputs label='mail' place="Mail id" informer="Enter your mail id Eg.check@yourmail.com" type='email' change={props.change} name='Mail id:'/>
